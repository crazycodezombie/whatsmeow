...
func (n *NoopStore) PutAllLabels(labelEdits []LabelEditEntry) error {
	return n.Error
}

func (n *NoopStore) GetLabel(id int) (*types.LabelInfo, error) {
	return nil, n.Error
}

func (n *NoopStore) GetAllLabels() (map[int]types.LabelInfo, error) {
	return nil, n.Error
}

func (n *NoopStore) GetLabelsContactsCounts() (map[int]int, error) {
	return nil, n.Error
}

func (n *NoopStore) PutAllLabelContacts(labelContacts []LabelContactEntry) error {
	return n.Error
}

func (n *NoopStore) GetAllLabelContacts(id int, ids ...int) (map[int][]types.ContactInfoWithJID, error) {
	return nil, n.Error
}
...
func (n *NoopStore) DeleteContactName(user types.JID) error {
	return n.Error
}
...
func (n *NoopStore) PutArchived(chat types.JID, archiveEntry ArchivedEntry) error {
	return n.Error
}
...
func (n *NoopStore) PutAllArchives(archives []ArchivedEntry) error {
	return n.Error
}

func (n *NoopStore) GetChatSettingsArchived(chat types.JID) (archiveEntry ArchivedEntry, ok bool, err error) {
	return ArchivedEntry{}, false, n.Error
}
